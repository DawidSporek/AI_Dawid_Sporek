...
ob_start(); ?>
    ...
    <ul class="index-list">
        <?php foreach ($comments as $comment): ?>
            <li>
                <h3><?= $comment->getAuthor() ?> <small>- <?= substr($comment->getContent(), 0, 12) ?>...</small></h3>
...
// Ścieżka do base.html.php pozostaje taka sama, bo wychodzimy folder wyżej (z /comment/ do /templates/)
